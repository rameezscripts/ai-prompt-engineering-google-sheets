...
![AI Prompt Engineering](https://img.shields.io/badge/AI-Prompt%20Engineering-0074D9?style=for-the-badge&logo=openai&logoColor=white)
...
> **90% of developers get mediocre code from AI — not because AI is bad, but because their prompts are weak.** This course fixes that.
...
| Step | Topic |
|------|-------|
| 01 | Why your prompt is everything |
| 02 | Bad Prompt vs Good Prompt — live comparison |
| 03 | The 5 Pillars of a perfect prompt |
| 04 | ChatGPT style — numbered rules |
| 05 | Gemini style — context first |
| 06 | Claude style — XML tags |
| 07 | DeepSeek style — explicit indexes |
| 08 | How to fix a bug with AI |
| 09 | How to get the perfect Sheets formula |
| 10 | 5 Golden Rules you must follow |

### Episode 2 — Advanced Techniques (6 Steps)
...
| 05 | **Iterative Refinement** | Build complex features layer by layer |
| 06 | **Prompt Cheat Sheet** | 6 copy-paste templates for any scenario |
...
|-------|----------|-------------|
| **ChatGPT** | General code, structured tasks | Numbered rules, bullet lists |
| **Gemini** | Context-heavy projects, Workspace integration | Background first, task at end |
| **Claude** | Complex logic, structured outputs | XML tags `<context>` `<task>` `<rules>` |
| **DeepSeek** | Performance-critical code, exact logic | Step-by-step with column indexes |
